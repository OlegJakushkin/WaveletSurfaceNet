...
"ax[0].plot(ep, [h['val_torus_t'] for h in hist], '-o', color='C0', label='torus-net | torus')",
"ax[0].plot(ep, [h['val_torus_s'] for h in hist], '-o', color='C1', label='super-net | torus')",
"ax[0].plot(ep, [h.get('val_cube_t', float('nan')) for h in hist], '--s', color='C0', label='torus-net | cube')",
"ax[0].plot(ep, [h.get('val_cube_s', float('nan')) for h in hist], '--s', color='C1', label='super-net | cube')",
